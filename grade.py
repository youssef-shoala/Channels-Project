...
point_breakdown_final = [
    ...
    (5, ["channel_test_stress_send_recv_buffered"]),
    (5, ["sanitize_test_stress_send_recv_buffered"]),
    (5, ["valgrind_test_stress_send_recv_buffered"]),
    ...
    (2, ["channel_test_select_with_duplicate_channel_buffered"]),
    (2, ["sanitize_test_select_with_duplicate_channel_buffered"]),
    (2, ["valgrind_test_select_with_duplicate_channel_buffered"]),
...
def grade():
    ...
    return (score_checkpoint, total_possible_checkpoint, score_final, total_possible_final, score_extra, total_possible_extra)

if __name__ == "__main__":
    score_checkpoint, total_possible_checkpoint, score_final, total_possible_final, score_extra, total_possible_extra = grade()
    print(f"Score: Checkpoint: {score_checkpoint} / {total_possible_checkpoint}, Final: {score_final} / {total_possible_final} Extra credit: {score_extra} / {total_possible_extra}")
